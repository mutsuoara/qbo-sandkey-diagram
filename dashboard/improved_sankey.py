"""
Improved Sankey diagram with better spacing and readability
"""
...
def create_improved_sankey_diagram(financial_data, start_date=None, end_date=None):
    """Create an improved Sankey diagram with better spacing and readability"""
    ...
    fig.update_layout(
        ...
        height=1000,  # Much taller for better spacing
